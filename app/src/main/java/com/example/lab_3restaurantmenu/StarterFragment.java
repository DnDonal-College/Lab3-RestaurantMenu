...
public class StarterFragment extends Fragment {
    ...
    public String starterSelection;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        radioGroup = getView().findViewById(R.id.radioGroupS);
        Button next = view.findViewById(R.id.starterNext);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                starterSelection = (String) radioButton.getText();
                Bundle bundle = new Bundle();
                bundle.putString("Option 1",starterSelection);
                Navigation.findNavController(v).navigate(R.id.action_starterFragment_to_dinnerFragment, bundle);
            }
        });
    }
}